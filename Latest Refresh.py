...
def push_status_to_powerbi(access_token, status_data):
    ...
    end_time = None if status_data['Status'] == "InProgress" else status_data['EndTime']
    ...
    while True:
        ...
        if status_data:
            ...
            if status != last_status:
                ...
                print(f"EndTime   : {status_data['EndTime']}")
                print("===================================")

                # Push to Power BI dashboard
...
if __name__ == "__main__":
    try:
        monitor_refresh(interval_sec=15)
